...
export default function Newsletter() {
  ...
  const handleSubmit = async (e) => { //Changed!
    ...
    try {
      ...
      const response = await fetch('http://localhost:8080/travanalys/storePhonenumber', { //Changed!
        method: 'POST', //Changed!
        headers: {
      ...
      <div className="mx-auto max-w-7xl px-6 lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-8 gap-y-16 lg:max-w-none lg:grid-cols-2">
          <div className="max-w-xl lg:max-w-lg">
            ...
            <form onSubmit={handleSubmit} className="mt-8 flex flex-col gap-y-4"> {/* Changed! */}
              {/* Email input */} 
              ...
              <button
                ...
                disabled={!consent || (!email && !phone)} //Changed!
              >
                Prenumerera
              </button>
            </form>
          ...
          <dl className="grid grid-cols-1 gap-x-8 gap-y-10 sm:grid-cols-2 sm:mt-20">
            ...
            <div className="flex flex-col items-center">
              ...
              <dd className="mt-2 leading-7 text-gray-400">
                <a href="mailto:travanalys@gmail.com" className="text-gray-300 hover:text-white">
