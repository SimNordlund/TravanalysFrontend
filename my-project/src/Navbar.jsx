...
export default function Navbar() {
  ...
  return (
    <div className="bg-white">
        ...
        <nav className="flex items-center justify-between p-6 lg:px-8" aria-label="Global">
          <div className="flex lg:flex-1">
            <a href="#" className="-m-1.5 p-1.5">
              <span className="sr-only">Ditt företag</span>
              <img
      ...
      <div className="relative isolate px-6 pt-14 lg:px-8 mt-[-90px]">
        <div
        ...
        <div className="mx-auto max-w-2xl py-32 sm:py-48 lg:py-56">
          <div className="hidden sm:mb-8 sm:flex sm:justify-center">
            <div className="relative rounded-full px-3 py-1 text-sm leading-6 text-gray-600 ring-1 ring-gray-900/10 hover:ring-gray-900/20" >
              Första gångare? Lugnt, vi hälper dig.{' '}
              <a href="#" className="font-semibold text-indigo-600">
                <span className="absolute inset-0" aria-hidden="true" />
                Häng med<span aria-hidden="true">&rarr;</span>
              </a>
            </div>
          </div>
          <div className="text-center">
            <h1 className="text-4xl font-bold tracking-tight text-gray-900 sm:text-6xl">
              Travanalys - The game changer
            </h1>
            <p className="mt-6 text-lg leading-8 text-gray-600">
              Bäst odds och statistik i travsektorn. Allt som krävs är en liten slant och en registrering. Signa upp via länken nedan eller testa graits!
            </p>
            <div className="mt-10 flex items-center justify-center gap-x-6">
              ...
              <a href="#" className="text-sm font-semibold leading-6 text-gray-900 shadow-sm ">
