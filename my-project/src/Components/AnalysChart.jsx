...
const AnalysChart = ({
  ...
  const [data, setData] = useState({
    labels: ["Delanalys 1", "Delanalys 2", "Delanalys 3", "Delanalys 4", "Delanalys 5", "Delanalys 6"],
    datasets: [],
  });
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        setData({
          labels: ["Delanalys 1", "Delanalys 2", "Delanalys 3", "Delanalys 4", "Delanalys 5", "Denanalys 6"],
          datasets,
        });
  ...
  return (
    <div className="flex flex-col justify-center items-center mt-1 sm:mt-0 px-2 pb-10">
      <div className="w-full text-center mb-1">
        <p className="text-sm sm:text-base text-slate-700 font-semibold">Delanalyser med de bästa perspektiven</p>
      </div>
